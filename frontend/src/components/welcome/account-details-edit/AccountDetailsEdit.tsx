...
//         this.state.editedUser.firstName = this.props.userStore.user.firstName;
//         this.state.editedUser.lastName = this.props.userStore.user.lastName;
...
//                         break;
//                     case 500:
//                         updateResponseMsg = "The request could not be completed due to an unknown error";
//                         updateWasSuccessful = false;
//                         responseHasBeenReceived = true;
//                         break;
//                     case 200:
...
//             ok = false;
//         }
//         if (err.repeatPassword == undefined && editedUser.newPassword != editedUser.repeatPassword) {
...
//                     <ConfirmModal msg={this.state.updateResponseMsg}
...
//                                         <input type="text" placeholder="First name" value={editedUser.firstName}
//                                                onChange={(event) => editedUser.firstName = event.target.value}
//                                                maxLength={50}/>
//                                         <ErrView errMsg={err.firstName}/>
//                                         <label>Last Name *</label>
//                                         <input type="text" placeholder="Last name" value={editedUser.lastName}
//                                                onChange={(event) => editedUser.lastName = event.target.value}
//                                                maxLength={50}/>
//                                         <ErrView errMsg={err.lastName}/>
//                                         <label>Email *</label>
//                                         <input type="text" placeholder="Email" value={editedUser.email}
//                                                onChange={(event) => editedUser.email = event.target.value}
//                                                maxLength={50}/>
...
//                                         <input type="password" placeholder="Old Password" value={editedUser.oldPassword}
//                                                onChange={(event) => editedUser.oldPassword = event.target.value}/>
//                                         <ErrView errMsg={err.oldPassword}/>
//                                         <label>New Password *</label>
//                                         <input type="password" placeholder="New Password" value={editedUser.newPassword}
//                                                onChange={(event) => editedUser.newPassword = event.target.value}/>
//                                         <ErrView errMsg={err.newPassword}/>
//                                         <label>Repeat Password *</label>
//                                         <input type="password" placeholder="Repeat Password"
//                                                value={editedUser.repeatPassword}
//                                                onChange={(event) => editedUser.repeatPassword = event.target.value}/>
...
//                         {
//                             this.state.responseHasBeenReceived && !this.state.updateWasSuccessful && (
//                                 <React.Fragment>
...
//                             )
//                         }
//                         <Link to="/account/details/view" type="button" className="bp3-button bp3-intent cancel">
//                             Cancel
//                         </Link>
//                         <button type="submit" className="bp3-button bp3-intent-primary save-shopping-list">
//                             Save
//                         </button>
//                     </div>
//                 </form>
